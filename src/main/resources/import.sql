...
insert into users (id, name, cpf, email, password, amount) values (3, 'Carlos', '123.456.789-03', 'carlos@example.com', 'carlos123', 3000.39);
insert into users (id, name, cpf, email, password, amount) values (4, 'Donald', '123.456.789-04', 'donald@example.com', 'donald123', 500.50);
insert into users (id, name, cpf, email, password, amount) values (5, 'Edinaldo', '123.456.789-05', 'edinaldo@example.com', 'edinaldo123', 1000.39);
insert into users (id, name, cpf, email, password, amount) values (6, 'Flávia', '123.456.789-06', 'flavia@example.com', 'flavia123', 6000.50);
